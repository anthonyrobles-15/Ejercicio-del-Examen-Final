...
public:
	ESTUDIANTES();//METODO CONSTRUCTOR
	...
	void Insertar( String^, String^, String^, String^, String^, String^, String^, String^);
	void Modificar(String^, String^, String^, String^, String^, String^, String^, String^, String^, String^);
